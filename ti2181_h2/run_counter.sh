...
echo
python count_cfg_freq.py parse_train.dat > results_without_vert
echo "A file 'modified_parse_train.dat' was made with an updated tree. "
echo "In addition, a file called 'results_without_vert' was made showing the resulting counts"
echo
